					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<?php 
									if(!empty($_SESSION['profil'])){
										echo '<li><a href="index.php?controle=utilisateur&action=bye"><i class="fa fa-lock"></i> Deconnexion </a></li>';
									}
									else{
										echo '<li><a href="index.php?controle=utilisateur&action=login"><i class="fa fa-lock"></i> Connexion </a></li>';
									}
								?>
							</ul>
						</div>
